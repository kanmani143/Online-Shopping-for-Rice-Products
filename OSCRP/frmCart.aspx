<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmCart.aspx.cs" Inherits="OSCRP.frmCart" %>
    ...
    <script type="text/javascript" >
        ...
        function CheckBoxAll(Checkbox, ClientID1) {
            ...
            for (i = 1; i < GridVwHeaderChckbox.rows.length; i++) {
                GridVwHeaderChckbox.rows[i].cells[1].getElementsByTagName("chbCheckOut")[15].checked = Checkbox.checked;
            }
        }
        chbCheckOut
    </script>
    ...
    <div style="position: relative; float: left; width: 1165px; top: 0px; right: -50px; text-align:left;">
              ...
              <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                ...
                <td colspan="4" align="center">
                    <asp:Label ID="lblRegistrationForm" runat="server" Text="My Cart" Font-Size="Large" ForeColor="#cc6699" Font-Names="viladimir script" Font-Bold="true" Font-Italic="" ></asp:Label>
              ...
              <asp:Label ID="lblcartNo" runat="server" Text=""  style="text-align: right" Visible="true"></asp:Label></span></p>
                            ...
                            <td style="border:solid;text-align:center;background-color:ghostwhite;">
                                <p><span style="font-size:medium;color:#cc6699;font-weight:bold" >Cart Items</span>&mdash;<span style="font-size: medium;color:black;font-weight:bold" >
              <asp:Label ID="lblCartItems" runat="server" Text=""  style="text-align: right" Visible="true"></asp:Label></span></p>
                            </td>
                                                        <td style="border:solid;text-align:center;background-color:ghostwhite;">
                                <p><span style="font-size:medium;color:#cc6699;font-weight:bold" >Cart Quanties</span>&mdash;<span style="font-size: medium;color:black;font-weight:bold" >
              <asp:Label ID="lblCartQty" runat="server" Text=""  style="text-align: right" Visible="true"></asp:Label></span></p>
                            </td>
                                                                                    <td style="border:solid;text-align:center;background-color:ghostwhite;">
                                <p><span style="font-size:medium;color:#cc6699;font-weight:bold" >Cart Price</span>&mdash;<span style="font-size: medium;color:black;font-weight:bold" >
              <asp:Label ID="lblCartPrice" runat="server" Text=""  style="text-align: right" Visible="true"></asp:Label></span></p>
                            </td>
                            <td style="border:solid;text-align:center;background-color:ghostwhite;">
                                <asp:ImageButton ID="imgCheckOut"  ImageAlign ="AbsBottom" runat="server" ImageUrl ="~/Images/ImgCheckOut.jpg"  Width="85px" Height="30px" ToolTip="CLICK HERE TO CHECK OUT NOW!" OnClick="imgCheckOut_Click" OnClientClick="return true;" /> 
                            </td>
                        </tr>
                                                <tr>
                            <td colspan="5" style="vertical-align: central" align="center">
                                <p><span style="font-size:medium;color:#cc6699;font-weight:bold" >Select All</span>&mdash;<span style="font-size: medium;color:black;font-weight:bold" >
                                    <%--<asp:CheckBox ID="chkSelectAll" runat="server" OnCheckedChanged="chkSelectAll_CheckedChanged" onclick="CheckBoxAll(this,'lstItemView');" />--%>
                                    <asp:ImageButton ID="ImageSelectALL"  ImageAlign ="AbsMiddle" runat="server" ImageUrl ="~/Images/CheckBoxUnChecked.jpg"  Width="20px" Height="20px" ToolTip="CLICK HERE TO SELECT ALL!"  OnClientClick="return true;" OnClick="ImageSelectALL_Click" /> 
                                                                                                                          </span></p>
                            </td>
                        </tr>
                    </table>                 
...
<p><span class="bold"><asp:Label ID="lblTitle" runat="server" Text='<%#Eval("TITLE") %>' Font-Size="small" ForeColor ="Black" style="text-align:justify" Visible="true"></asp:Label></span>&mdash;</p>
        <p style="font-size:medium;"><asp:Label ID="lblDesc" runat="server" Text='<%#Eval("Description") %>' Font-Size="medium" ForeColor ="Black" style="text-align:justify" Visible="true"></asp:Label></p>
          <p><span style="font-size:Smaller;color:#cc6699;font-weight:bold" >Total Qty</span>&mdash;<span style="font-size: smaller;color:black;font-weight:bold" >
              ...
              <asp:Label ID="lblTotalPrice" runat="server" Text='<%#Eval("monPrdTotPrice","{0:0.00}") %>'    Visible="true"></asp:Label>
                                                                              ...
                                                                              <p><span style="font-size:Smaller;color:#cc6699;font-weight:bold; text-align:center;" >Checkout</span>&mdash;<span style="font-size: smaller;color:black;font-weight:bold; vertical-align:bottom;" >
                                                                                  <%--<asp:CheckBox ID="chbCheckOut" runat="server" CommandName="SelectCheck" OnCommand="ClickButton" OnClientClick="return true;"/>--%>
                    <asp:ImageButton ID="ImgchbCheckOut"  ImageAlign ="AbsMiddle" runat="server" ImageUrl ="~/Images/CheckBoxUnChecked.jpg"  Width="20px" Height="20px" ToolTip="CLICK HERE TO SELECT OR UNSELECT" CommandName="SelectCheck" OnCommand="ClickButton" OnClientClick="return true;" /> 
                                                                                                    </span></p>  
                                    <p><span style="font-size: smaller;color:black;font-weight:bold; vertical-align:bottom;" >
                                                                                  
                    <asp:ImageButton ID="btnRemove"  ImageAlign ="AbsMiddle" runat="server" ImageUrl ="~/Images/btnRemove.jpg"  Width="70px" Height="35px" ToolTip="CLICK HERE TO REMOVE" CommandName="RemoveItem" OnCommand="ClickButton" OnClientClick="return confirm('Are you sure you want to delete?');" 
                        CommandArgument='<%# DataBinder.Eval(((IDataItemContainer)Container).DataItem, "nvrPrdNo") %>' /> 
                                                                                                    </span></p> 
